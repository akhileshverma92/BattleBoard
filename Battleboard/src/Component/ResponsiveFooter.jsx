...
const ResponsiveFooter = () => {
    ...
    return (
        <footer className="bg-white boxShadow rounded-xl w-full p-3 lg:p-4 relative">
            ...
            <div
                className="w-full flex items-center justify-center  flex-col gap-[20px] pb-[110px]">
                
              

                <button className=" px-6 rounded-full bg-primary text-white">Contact Us</button>
